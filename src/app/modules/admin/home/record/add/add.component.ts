...
export class AddComponent implements OnInit {
  ...
  createForm() {
    ...
    this.Form = this.fb.group({
      ...
      mini_title: ['',Validators.required],
      body: [this.newsBody,Validators.required],
      youtube_link: ['',Validators.required],
  ...
  onSubmit() {
    ...
    formData.append('subcategory_id', this.f.subcategory_id.value);
